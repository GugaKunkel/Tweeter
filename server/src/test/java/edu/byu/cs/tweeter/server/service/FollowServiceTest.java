...
public class FollowServiceTest {
    ...
    private Pair<List<String>, Boolean> data;
    ...
    public void setup() {
        ...
        data = null;
                new FollowingResponse(Arrays.asList(resultUser1, resultUser2, resultUser3), false);
        mockFollowDAO = Mockito.mock(FollowsDAO.class);
        Mockito.when(mockFollowDAO.getFollowees(request.getFollowerAlias(), request.getLastFolloweeAlias(), request.getLimit())).thenReturn(data);
